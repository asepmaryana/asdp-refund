...
$config['auth_override_class_method_http']['tiketRefund']['proses']['post'] = 'none';
$config['auth_override_class_method_http']['tiketRefund']['cek']['get'] = 'none';
$config['auth_override_class_method_http']['tiketRefund']['cetak']['get'] = 'none';
$config['auth_override_class_method_http']['pdf']['test']['get'] = 'none';
$config['auth_override_class_method_http']['tiketSales']['cek']['get'] = 'none';
$config['auth_override_class_method_http']['tiketSales']['info']['get'] = 'none';
$config['auth_override_class_method_http']['tiketSalesDetail']['sum']['get'] = 'none';
$config['auth_override_class_method_http']['identitas']['lists']['get'] = 'none';
$config['auth_override_class_method_http']['bank']['lists']['get'] = 'none';
